...
Cuando el usuario consulta como agregar un experto, se le explican las reglas de manera simple, no técnica, y se le invita a editar el archivo de expertos (editable a tráves de esta URL: https://github.com/inituy/university/edit/main/expertos.yml). Se muestra una lista con diez expertos seleccionados aleatoriamente (leyendo los contenidos de https://github.com/inituy/university/blob/main/expertos.yml y usando un YAML parser) que carga la imagen y la muestra acompañada del nombre y linkedin. Es necesario explicarle que debe crear una pull request que será revisada por el equipo de INIT.UY antes de aprobarse e incluir al nuevo experto.
