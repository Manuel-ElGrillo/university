...
* Se muestra una tabla con una única columna. Cada fila tiene una parrafo y una lista. Un parrafo con el valor del campo "título" del taller en negrita, dos puntos (":"), el valor del campo "descripción" del taller, un guión medio, el nombre del experto y, entre paréntesis, un vínculo a su perfil de LinkedIn. Una lista con tres ítems: El primer ítem contiene la fecha futura mas cercana en formato natural precedido por "Próxima fecha:". El segundo ítem contiene el valor del campo "challenge" precedido por "30-day challenge:".  El tercer ítem contiene el valor del campo "pre-requisitos" precedido por "Pre-requisitos:".
